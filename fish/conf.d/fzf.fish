...
set --global --export FZF_DEFAULT_OPTS "
    ...
    --layout=reverse
    --border=none
    --color='16,fg+:-1:regular,bg+:-1,fg:dim,info:15,gutter:8,pointer:14:regular,prompt:14:regular,border:15:dim,query:-1:regular,marker:14:regular,header:15,spinner:yellow,hl:cyan:dim:underline,hl+:regular:cyan:underline'
    --margin=3%
    --height 100%
    --prompt='> '
    --tabstop=2
