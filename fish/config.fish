...
if status is-interactive
    ...
    set --global --export FZF_DEFAULT_OPTS "
        --cycle
        --ellipsis='…'
        --bind 'tab:down,shift-tab:up,alt-down:preview-page-down,alt-up:preview-page-up,change:first,alt-o:change-preview-window(right,border-left,50%|bottom,border-top,60%),ctrl-/:preview(fzf-help-preview),ctrl-\\:refresh-preview'
        --layout=reverse
        --border=rounded
