...
" ------------------------------------
    ...
    Plugin 'lifepillar/vim-mucomplete'
        ...
        \ 'default': ['path', 'user', 'omni', 'c-n', 'dict'],
        \ 'vim': ['path', 'keyn', 'dict', 'cmd']
        \ }
    Plugin 'dense-analysis/ale'
        ...
        let g:multicomplete_completers = [function('csscomplete#CompleteCSS'), function('emmet#completeTag')]
        function! MultiComplete(findstart, base)
            ...
            let l:array_len = len(l:replaceable_chars)
            for l:Completer in g:multicomplete_completers
                if g:findstarts->get(l:i) >= 0
                    let l:completer_results = l:Completer(a:findstart, a:base)[0:4]
...
" ---------------------
    ...
    if has('autocmd')
        ...
        augroup SetVimFoldMethod
            ...
            " string denoting the currently active completion method, to be
            " used in a statusline
            autocmd Filetype vim execute "set foldmethod=indent"
        augroup END
        ...
        " augroup SetOmniFunc
        "     autocmd!
        "     autocmd BufEnter * execute "set omnifunc=MultiComplete"
        " augroup END
