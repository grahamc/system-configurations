...
set --global --export FZF_DEFAULT_OPTS " \
    ...
    --layout=reverse \
    --border=none \
    --color='16,fg+:-1:regular:underline,bg+:-1,info:15,gutter:-1,pointer:-1:bold,prompt:6:regular,border:15:dim,query:-1:regular,marker:-1:bold,header:15,spinner:yellow,hl:cyan:dim,hl+:regular:cyan:underline,scrollbar:15:dim' \
    --margin=3% \
    --height 100% \
